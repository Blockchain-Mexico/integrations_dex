                        ...
                        <THead>
                            <TR>
                                <THStyled>
                                    Liquidex total
                                    <TooltipStyled
                                        description="Liquidez total en todos los depositos de ETH."
                                ...
                                Colateral
                                    <TooltipStyled
                                        description="Colateral total disponible en ETH que puede ser usado para prestar"
                                        iconType={IconType.Fill}
                                    />
                                </THStyled>
                                <THStyled>
